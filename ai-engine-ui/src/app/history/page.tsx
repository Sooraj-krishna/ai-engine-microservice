      ...
      <div className="max-w-4xl mx-auto">
        <AnimatedSection>
          <div className="dark-card p-12 text-center">
            ...
            <a
              href="/analysis"
              className="inline-block px-8 py-3 bg-white text-black hover:bg-gray-100 rounded-full font-bold uppercase tracking-wider transition-all shadow-lg"
            >
              Start Analysis
            </a>
          </div>
        ...
        <div className="mt-12 space-y-4">
          {[
            ...
            <AnimatedSection key={index} delay={index * 0.1}>
              <div className="dark-card p-6 flex items-center space-x-4">
                ...
                {item.status === 'error' && <XCircle className="h-6 w-6 text-red-400 flex-shrink-0" />}
